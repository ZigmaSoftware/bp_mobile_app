...
bp_send_json([
    'status' => true,
    'message' => 'Attendance regularization notifications loaded',
    'data' => [
        'items' => bp_att_reg_fetch_notifications($employeeId, $unreadOnly, $limit),
        'unread_count' => bp_att_reg_unread_count($employeeId),
    ],
]);
